...
function Edit({ blogsData }) {
  ...
  const onSubmit = (data) => {
    ...
    axios.patch(`${process.env.MONGO_URI}/api/blogs/${id}`, formData);
    navigate("/");
  };

  function handleDelete() {
    axios.delete(`${process.env.MONGO_URI}/api/blogs/${id}`);
    navigate("/");
  }
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className={styles.form}>
      <img
        src={ blogImage === "" ? blog.image === "" || !blog.image ? emptyImage: blog.filePath : blogImage }
        alt="blog-image"
      />
